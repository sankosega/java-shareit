...
public class BookerCurrentBookingStrategy implements BookerBookingSearchStrategy {
    ...
    public List<Booking> findBookings(Long userId, LocalDateTime now, Sort sort) {
        return bookingRepository.findByBooker_IdAndStartIsBeforeAndEndIsAfter(userId, now, now, sort);
    }
}
